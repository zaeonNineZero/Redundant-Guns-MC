...
public class SidearmPistolModel implements IOverrideModel
{
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack, ItemStack parent, @Nullable LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
    {
        ...
        BakedModel bakedModel = RedundantSpecialModels.SIDEARM_PISTOL_BASE.getModel();
		...
		{
            RenderUtil.renderModel(RedundantSpecialModels.SIDEARM_PISTOL_RAILMOUNT.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		}
        ...
        RenderUtil.renderModel(RedundantSpecialModels.SIDEARM_PISTOL_SLIDE.getModel(), transformType, null, stack, parent, poseStack, buffer, light, overlay);
		...
		// Render the transformed model.
        RedundantSpecialModels magModel = RedundantSpecialModels.SIDEARM_PISTOL_MAGAZINE;
        try {
            ...
            if(!magStack.isEmpty())
            {
	            if (magStack.getItem().builtInRegistryHolder().key().location().getPath().equals("extended_magazine"))
			    	magModel = RedundantSpecialModels.SIDEARM_PISTOL_EXTENDED_MAG;
            }
		}
